export const translations = {
  ...
  pt: {
    ...
    configurationTitle: "Configuração do Airdrop Street Dog Coin",
    ...
    setupInstructions:
      "Siga este guia passo a passo para configurar e implantar o sistema de airdrop Street Dog Coin. Certifique-se de seguir cada etapa cuidadosamente para garantir a configuração correta.",
    ...
    cloneRepository: "Clone o repositório do GitHub: git clone https://github.com/seu-usuario/streetdogcoin-airdrop.git",
    ...
    readyToLaunchDescription:
      "Após seguir todas essas etapas, seu airdrop Street Dog Coin estará configurado e pronto para ser lançado. Lembre-se de monitorar constantemente o desempenho e fornecer suporte aos participantes.",
    changelog: "Histórico de Alterações",
    changelogDescription: "Histórico de Atualizações do Airdrop Street Dog Coin",
    ...
    initialRelease: "Lançamento inicial do Airdrop Street Dog Coin",
